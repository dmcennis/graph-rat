...
public class BasicPathSetTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        nz.ac.waikato.mcennis.rat.graph.descriptors.Properties props1 = PropertiesFactory.newInstance().create();


        props1.set("ActorType","User");


        props1.set("ActorID","A");


        a = ActorFactory.newInstance().create(props1);


        props1.set("ActorID","B");


        b = ActorFactory.newInstance().create(props1);


        props1.set("ActorID","C");


        c = ActorFactory.newInstance().create(props1);


        props1.set("ActorID","D");


        d = ActorFactory.newInstance().create(props1);


        props1.set("ActorID","E");


        e = ActorFactory.newInstance().create(props1);
