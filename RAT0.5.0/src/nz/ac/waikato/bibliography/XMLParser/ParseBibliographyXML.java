...
public class ParseBibliographyXML extends Handler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (state == State.BIBLIOGRAPHY) {
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("abstract",String.class);
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        ...
        if (state == State.AUTHOR_ID) {
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("year",String.class);
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("file",String.class);
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("type",String.class);
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("journal",String.class);
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("cluster",String.class);
            ...
            Property property = nz.ac.waikato.mcennis.rat.graph.property.PropertyFactory.newInstance().create("title",String.class);
