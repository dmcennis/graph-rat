...
public class HalfLifeTest extends TestCase {
    ...
    public void testExecuteB() {
        ...
        assertEquals(0.7040,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteGraph() {
        ...
        assertEquals(0.6720,((Double)values.get(0)).doubleValue(),0.0001);
        ...
        assertEquals(1.3345,((Double)values.get(0)).doubleValue(),0.0001);
