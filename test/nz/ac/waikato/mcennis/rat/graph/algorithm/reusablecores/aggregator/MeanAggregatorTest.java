/**
 * Created Aug 12, 2008 - 3:33:42 PM
 * Copyright Daniel McEnnis, see license.txt
 */

package nz.ac.waikato.mcennis.rat.graph.algorithm.reusablecores.aggregator;

import nz.ac.waikato.mcennis.rat.reusablecores.aggregator.MeanAggregator;
 ...
 */
public class MeanAggregatorTest extends TestCase {
    ...
    public MeanAggregatorTest(String testName) {
        super(testName);
    }            
    ...
    public void testAggregateSameDataset(){
        ...
        MeanAggregator instance = new MeanAggregator();
        ...
        assertEquals(1.5,result[0].value(0),0.0001);
