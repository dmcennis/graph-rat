/**
 * Created Aug 12, 2008 - 3:33:49 PM
 * Copyright Daniel McEnnis, see license.txt
 */

package nz.ac.waikato.mcennis.rat.graph.algorithm.reusablecores.aggregator;

import nz.ac.waikato.mcennis.rat.reusablecores.aggregator.MaxAggregator;
 ...
 */
public class MaxAggregatorTest extends TestCase {
    ...
    public MaxAggregatorTest(String testName) {
        super(testName);
    }            
    ...
    public void testAggregateSameDataset(){
        ...
        MaxAggregator instance = new MaxAggregator();
        ...
        assertEquals(numericInstanceWithDataset2,result[0]);
