...
public class MeanErrorEvaluationTest extends TestCase {
    ...
    public void testExecuteMeanErrorC() {
        ...
        assertEquals(1.125,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteMeanErrorGraph() {
        ...
        assertEquals(0.4464,((Double)values.get(0)).doubleValue(),0.0001);
        ...
        assertEquals(1.3705,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteMeanSquaredErrorC() {
        ...
        assertEquals(1.40625,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteMeanSquaredErrorGraph() {
        ...
        assertEquals(0.4866,((Double)values.get(0)).doubleValue(),0.0001);
        ...
        assertEquals(1.820,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteRootMeanSquaredErrorC() {
        ...
        assertEquals(0.8385,((Double)values.get(0)).doubleValue(),0.0001);
    ...
    public void testExecuteRootMeanSquaredErrorGraph() {
        ...
        assertEquals(0.4055,((Double)values.get(0)).doubleValue(),0.0001);
        ...
        assertEquals(1.052,((Double)values.get(0)).doubleValue(),0.0001);
