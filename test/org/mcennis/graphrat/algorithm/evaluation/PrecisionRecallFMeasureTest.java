...
public class PrecisionRecallFMeasureTest extends TestCase {
    ...
    public void testExecutePrecisionA() {
        ...
        assertEquals(0.5,((Double)values.get(0)).doubleValue(),0.001);
    ...
    public void testExecutePrecisionC() {
        ...
        assertEquals(1.0,((Double)values.get(0)).doubleValue(),0.001);
    ...
    public void testExecutePrecisionGraph() {
        ...
        assertEquals(0.5714,((Double)values.get(0)).doubleValue(),0.001);
        ...
        assertEquals(1.214,((Double)values.get(0)).doubleValue(),0.001);
    ...
    public void testExecuteFMeasureA() {
        ...
        assertEquals(0.6667,((Double)values.get(0)).doubleValue(),0.001);
    ...
    public void testExecuteFMeasureGraph() {
        ...
        assertEquals(0.5476,((Double)values.get(0)).doubleValue(),0.001);
        ...
        assertEquals(1.040,((Double)values.get(0)).doubleValue(),0.001);
