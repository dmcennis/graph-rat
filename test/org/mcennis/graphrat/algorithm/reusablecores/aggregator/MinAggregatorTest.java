/**
 * Created Aug 12, 2008 - 3:33:36 PM
...
public class MinAggregatorTest extends TestCase {
    ...
    public MinAggregatorTest(String testName) {
        super(testName);
    }            
    ...
    public void testAggregateSameDataset(){
        ...
        MinAggregator instance = new MinAggregator();
    ...
    public void testAggregateDifferingDataset(){
        ...
        assertNotNull(result);
        assertEquals(1,result.length);
        assertEquals(emptyInstanceWithDataset,result[0]);
