/**
 * Created Aug 12, 2008 - 3:33:08 PM
 * Copyright Daniel McEnnis, see license.txt
 */

package org.mcennis.graphrat.algorithm.reusablecores.aggregator;

import org.mcennis.graphrat.reusablecores.aggregator.StandardDeviationAggregator;
 ...
 */
public class StandardDeviationAggregatorTest extends TestCase {
    ...
    public StandardDeviationAggregatorTest(String testName) {
        super(testName);
    }            
    ...
    public void testAggregateSameDataset(){
        ...
        StandardDeviationAggregator instance = new StandardDeviationAggregator();
    ...
    public void testSingleEntry(){
        ...
        assertEquals(1,result.length);
        assertEquals(1,result[0].numAttributes());
        assertEquals(Double.NaN,result[0].value(0));
