...
import nz.ac.waikato.mcennis.rat.graph.query.OrQuery;

/**
 *
 * @author Daniel McEnnis
 */
public class OrGraphQuery extends OrQuery implements GraphQuery{
    ...
    public OrGraphQuery prototype(){
        return new OrGraphQuery();
    }
}
