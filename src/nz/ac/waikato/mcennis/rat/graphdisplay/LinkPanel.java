...
public class LinkPanel extends JScrollPane {
    ...
    public void loadLink(VisualItem linkItem) {
        ...
        JLabel typeLabel = new JLabel(link.getRelation());
        ...
        JLabel sourceTypeLabel = new JLabel(link.getSource().getMode());
        ...
        JLabel destinationTypeLabel = new JLabel(link.getDestination().getMode());
        ...
        Property[] propertyList = link.getProperty().toArray(new Property[]{});
        ...
        if (propertyList != null) {
            ...
            for (int i = 0; i < propertyList.length; ++i) {
                ...
                if (propertyList[i].getValue().get(0).toString().length() > 30) {
