...
public class LastFMUserExpansion {
    ...
    boolean parseProfile = true;

    boolean parseArtists = true;

    boolean parseUserArtist = true;



    public boolean isParseArtists() {
    ...
    public void setParseArtists(boolean parseArtists) {

        this.parseArtists = parseArtists;
    ...
    boolean parseTopArtists = true;

    boolean parseTags = true;

    boolean parseFriends = true;

    boolean parseSimilar = true;
    ...
    public Parser[] setUpParsers(File toFileDirectory,Graph graph, String[] parserNames){
        ...
        if((toFileDirectory != null)&&(parserNames != null)&&(parserNames.length==8)){
            ...
            topArtists.setParseArtist(parseArtists);

            topArtists.setParseUserArtist(parseUserArtist);
    ...
    public void setParseFriends(boolean parseFriends) {

        this.parseFriends = parseFriends;

    }



    public boolean isParseProfile() {
    ...
    public void setParseProfile(boolean parseProfile) {
    ...
    public void setParseSimilar(boolean parseSimilar) {

        this.parseSimilar = parseSimilar;
    ...
    public boolean isParseTopArtists() {
    ...
    public void setParseTopArtists(boolean parseTopArtists) {

        this.parseTopArtists = parseTopArtists;
