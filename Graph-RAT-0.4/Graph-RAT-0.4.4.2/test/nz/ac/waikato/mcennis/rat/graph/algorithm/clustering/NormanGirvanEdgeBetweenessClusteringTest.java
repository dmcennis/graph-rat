...
public class NormanGirvanEdgeBetweenessClusteringTest extends TestCase {
    ...
    public void testExecuteNull() {
        ...
        Graph[] children = base2.getChildren();
        assertNull(children);
    }
    ...
    public void testExecuteComplicated() {
        ...
        for(int i=0;i<4;++i){
            if(children[i].getActor("Member", "G2A") != null){
                assertNotNull(children[i].getChildren());
                assertEquals(3,children[i].getChildren().length);
            }else if(children[i].getActor("Member","Isolated") != null){
                assertNull(children[i].getChildren());
            }else if(children[i].getActor("Member","Bridge") != null){
                assertNull(children[i].getChildren());
            }else if(children[i].getActor("Member","G2A") != null){
                assertNotNull(children[i].getChildren());
                assertEquals(2,children[i].getChildren().length);
            }
        }
    }
