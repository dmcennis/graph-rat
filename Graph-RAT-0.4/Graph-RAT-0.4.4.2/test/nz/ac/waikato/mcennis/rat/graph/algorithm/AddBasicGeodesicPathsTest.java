...
public class AddBasicGeodesicPathsTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        props.setProperty("GraphType","Memory");
    ...
    public void testPathSetName(){
        AddBasicGeodesicPaths test = new AddBasicGeodesicPaths();
        test.execute(g);
    ...
    public void testAPaths(){
        ...
        PathSet[] set = g.getPathSet();
        assertEquals(1,set.length);
        Path[] paths = set[0].getPathBySource("A");
        assertNotNull(paths);
    ...
    public void testBPaths(){
        ...
        PathSet[] set = g.getPathSet();
        assertEquals(1,set.length);
        Path[] paths = set[0].getPathBySource("B");
        assertNotNull(paths);
        assertEquals(4,paths.length);
        for(int i=0;i<paths.length;++i){
    ...
    public void testCPaths(){
        ...
        PathSet[] set = g.getPathSet();
        assertEquals(1,set.length);
        Path[] paths = set[0].getPathBySource("C");
        assertNotNull(paths);
        assertEquals(4,paths.length);
        for(int i=0;i<paths.length;++i){
            if(paths[i].getEnd().getID().contentEquals("B")){
    ...
    public void testDPaths(){
        ...
        PathSet[] set = g.getPathSet();
        assertEquals(1,set.length);
        Path[] paths = set[0].getPathBySource("D");
        assertNotNull(paths);
        assertEquals(4,paths.length);
        for(int i=0;i<paths.length;++i){
            if(paths[i].getEnd().getID().contentEquals("B")){
    ...
    public void testEPaths(){
        ...
        PathSet[] set = g.getPathSet();
        assertEquals(1,set.length);
        Path[] paths = set[0].getPathBySource("E");
        assertNull(paths);
    }
